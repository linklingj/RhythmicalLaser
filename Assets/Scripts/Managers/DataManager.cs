...
public struct Save_MusicData {
    ...
    public bool clear;
    public int score;
    public Save_MusicData(int musicNum, string name, bool clear, int score) {
...
public class DataManager : MonoBehaviour
{
    ...
    public void ResetData() {
        ...
        Save_MusicData[] harangMusics = new Save_MusicData[] {
            new Save_MusicData(1, "Attention", false, 0),
            new Save_MusicData(2, "BOCA", false, 0),
            new Save_MusicData(3, "LOONATIC", false, 0)
        };

        Save_MusicData[] himeMusics = new Save_MusicData[] {
            new Save_MusicData(1, "Sugar Song To Bitter Step", false, 0)
        };
        ...
        Save_MusicData[] jimmyMusics = new Save_MusicData[] {
            new Save_MusicData(1, "Blinding Lights", false, 0)
        };
